...
internal class Janitor : Utility
{
    ...
    {
        var janitorCat = Main.MenuCat.CreateSubPanel("The Janitor", "#ecff6d");
        janitorCat.CreateEnumElement("Clear Type", Color.white, ClearType.Everything, UpdateType);
        janitorCat.CreateFunctionElement("Clear", Color.white, Clear);
        janitorCat.CreateFunctionElement("Reset Map", Color.white, Reset);
    ...
    private static void Reset()
    {
        ...
        {
            var placers = Object.FindObjectsOfType<SpawnableCratePlacer>();
